...
const Container = styled.section`
  ...
  .notification-preferences{display:flex!important;align-items:center;gap:16px;border:1px solid ${({ theme }) => theme.color2};border-radius:10px;padding:9px 12px;margin:0;color:${({ theme }) => theme.colorSubtitle}.notification-preferences legend{padding:0 5px;font-size:11px;font-weight:850}.notification-preferences label{display:flex!important;align-items:center;grid-template-columns:none!important;gap:6px!important;font-size:12px;font-weight:750}.notification-preferences input{width:auto!important;padding:0!important}
